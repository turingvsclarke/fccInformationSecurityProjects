...
var registerCache = _interopRequireWildcard(require("@babel/register/lib/cache"));
...
function compile(code, filename) {
  const opts = new babel.OptionManager().init(Object.assign(Object.assign({
  ...
  if (!cached || cached.mtime !== mtime(filename)) {
    cached = babel.transform(code, Object.assign(Object.assign({}, opts), {}, {
...
function register(opts = {}) {
  ...
  delete opts.cache;
  transformOpts = Object.assign(Object.assign({}, opts), {}, {
